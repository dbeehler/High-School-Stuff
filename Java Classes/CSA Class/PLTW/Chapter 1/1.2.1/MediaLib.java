...
public class MediaLib
{
    public static void main()
    {
        ...
        Song song3 =  new Song("Mack the Knife", 1.29, 5);
        numSongs = numSongs + 1;
        ...
        Song song4 =  new Song("How Do I Live", 99, 5);
        numSongs = numSongs + 1;
        ...
        Song song5 =  new Song("Party Rock Anthem", 1.29, 5);
        numSongs = numSongs + 1;
        ...
        Song song6 =  new Song("I Gotta Feeling", .99, 5);
        numSongs = numSongs + 1;
        ...
        Song song7 =  new Song("Macaren", 1.29, 5);
        numSongs = numSongs + 1;
        ...
        Song song8 =  new Song("Physical", .99, 5);
        numSongs = numSongs + 1;
        ...
        Song song9 =  new Song("You Light Up My Life", 1.29, 4);
        numSongs = numSongs + 1;
